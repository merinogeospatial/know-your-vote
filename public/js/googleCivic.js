...
$.ajax({
  ...
  .then(function(response) {
    ...
    googleCivicObj = {
      districtName: response.divisions[division_id].name,
      officeIndex: response.divisions[division_id].officeIndices[0],
      officeName: response.offices[officeIndex].name,
      officialName: response.officials[officialIndex].name,
      officialParty: response.officials[officialIndex].party,
      officialPhone: response.officials[officialIndex].phones[0],
      officialURL: response.officials[officialIndex].urls[0],
      imgURL: response.officials[officialIndex].urls[0]
    };
  });
